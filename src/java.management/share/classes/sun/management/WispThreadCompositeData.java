...
public class WispThreadCompositeData extends LazyCompositeData {
    ...
    protected CompositeData getCompositeData() {
        ...
        items.put(THREAD_ID, task.getThreadWrapper().getId());
        items.put(THREAD_NAME, task.getThreadWrapper().getName());
        items.put(THREAD_STATE, task.getThreadWrapper().getState().name());
        Object parkBlocker = LockSupport.getBlocker(task.getThreadWrapper());
        ...
        items.put(DAEMON, task.getThreadWrapper().isDaemon());
        items.put(PRIORITY, task.getThreadWrapper().getPriority());
