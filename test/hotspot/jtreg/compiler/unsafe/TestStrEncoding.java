 ...
 * @summary test for aarch64 str encoding
 * @build TestStrEncoding
 * @run main/othervm -XX:CompileCommand=exclude,*::toBytesDup TestStrEncoding
 * @run main/othervm -XX:CompileCommand=exclude,*::toBytesDup TestStrEncoding
 * @run main/othervm -XX:CompileCommand=exclude,*::toBytesDup TestStrEncoding
 * @run main/othervm -XX:CompileCommand=exclude,*::toBytesDup TestStrEncoding
 * @run main/othervm -XX:CompileCommand=exclude,*::toBytesDup TestStrEncoding
