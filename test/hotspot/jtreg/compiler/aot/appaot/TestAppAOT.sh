...
# @test
# @summary test usage of AppAOT
# @run shell TestAppAOT.sh
...
#run test
${JAVA} -XX:+UseAppAOT -XX:+UnlockExperimentalVMOptions -XX:+PrintAOT -XX:+PrintCompilation -Xlog:aot*=debug ${TEST_CLASS} >> output.txt
