...
# TODO: remove AOTSkipSepcialInlining when we could inline super method
${JAOTC} --output ${AOT_LIB} -J-Dgraal.PrintCompilation=true --verbose -J-cp -J${SUB_DIR} -J-Dgraal.AOTSkipSpecialInlining=true ${TEST_SUB_CLASS}.class > aotc.log
if [ $? != '0' ]
then
