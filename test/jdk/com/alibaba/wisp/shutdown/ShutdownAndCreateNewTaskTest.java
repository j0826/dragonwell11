 ...
 * @run main/othervm  -XX:+MultiTenant -XX:+TenantDataIsolation -XX:+TenantThreadStop -XX:+UseG1GC -XX:+EnableCoroutine -XX:+UseWispMonitor -Dcom.alibaba.wisp.transparentWispSwitch=true ShutdownAndCreateNewTaskTest
 */
...
public class ShutdownAndCreateNewTaskTest {
